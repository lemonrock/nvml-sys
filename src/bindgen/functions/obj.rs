...
extern "C"
{
	...
	pub fn pmemobj_cancel(pop: *mut PMEMobjpool, actv: *mut pobj_action, actvcnt: c_int);
	...
	pub fn pmemobj_publish(pop: *mut PMEMobjpool, actv: *mut pobj_action, actvcnt: c_int);
	pub fn pmemobj_realloc(pop: *mut PMEMobjpool, oidp: *mut PMEMoid, size: usize, type_num: u64) -> c_int;
	pub fn pmemobj_reserve(pop: *mut PMEMobjpool, act: *mut pobj_action, size: usize, type_num: u64) -> PMEMoid;
	...
	pub fn pmemobj_set_value(pop: *mut PMEMobjpool, act: *mut pobj_action, ptr: *mut u64, value: u64);
	...
	pub fn pmemobj_xalloc(pop: *mut PMEMobjpool, oidp: *mut PMEMoid, size: usize, type_num: u64, flags: u64, constructor: pmemobj_constr, arg: *mut c_void) -> c_int;
	pub fn pmemobj_xreserve(pop: *mut PMEMobjpool, act: *mut pobj_action, size: usize, type_num: u64, flags: u64) -> PMEMoid;
