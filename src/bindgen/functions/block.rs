...
extern "C"
{
	...
	pub fn pmemblk_set_funcs(malloc_func: Option<extern "C" fn(size: size_t) -> *mut c_void>, free_func: Option<unsafe extern "C" fn(ptr: *mut c_void)>, realloc_func: Option<unsafe extern "C" fn(ptr: *mut c_void, size: size_t) -> *mut c_void>, strdup_func: Option<unsafe extern "C" fn(s: *const c_char) -> *mut c_char>);
